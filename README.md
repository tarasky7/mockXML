...
## How it works
- The Nginx server will forward the request for broker XML message to the mockXML server. To be specific, the nginx will proxy the AJAX request for "/broker/xml" to the mockup Server.
